...
func SaveAll(ctx context.Context, client *ent.Client, socialLinks map[string]string, landingDomains []string) error {
...
func (s *SocialLinkService) SaveSocialLinks(ctx context.Context, socialLinks map[string]string, sourceDomain string) error {
	...
	for link, pageurl := range socialLinks {
